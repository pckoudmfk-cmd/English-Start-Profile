...
// Главная страница студента. Достижения (Этап 8) и зачёт (Этап 9) —
// реализованы, доступны через боковую навигацию. Цели — по-прежнему не
// реализованы (см. следующие этапы). Статусы анкетирования и
// диагностики — реальные.
